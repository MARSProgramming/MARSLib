...
public class SimMotorState {
    ...
    public void step(Torque finalElectricTorque, Torque finalFrictionTorque, MomentOfInertia loadMOI, Time dt) {
        // Step 0: Convert all units to SI units (radians, radians per second, Newton-meters, seconds,
        // kg*m²)
        ...
        // zero.
        // If friction causes the motor to reverse direction, or if the velocity reaches zero, set the
        // angular velocity
        // to zero.
        ...
        // The new angular position is the current position plus the change in position over the time
        // step.
