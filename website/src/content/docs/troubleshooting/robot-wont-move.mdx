...
Your robot should move when you press the joystick. If it doesn't, follow this checklist to find and fix the problem.
...
- [Motor Configuration Guide](/tutorials/hardware/motor-setup)
