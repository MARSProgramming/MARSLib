...
[Learn More](/framework-structure/io-layer)
...
[Zero-Allocation Guide](/framework-structure/zero-allocation)
...
[State Machine Guide](/framework-structure/state-machines)
