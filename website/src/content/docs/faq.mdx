...
[Full Setup Guide](/getting-started/01-setup-and-infrastructure)
...
[Learn More](/framework-architecture/io-layer)
...
[Zero-Allocation Guide](/framework-architecture/zero-allocation)
...
[Simulation Guide](/advanced/simulation-best-practices)
...
[Performance Guide](/advanced/performance-analysis)
...
[WPILib Migration Guide](/getting-started/migration/from-wpilib)
...
[State Machine Guide](/framework-architecture/state-machines)
...
[PathPlanner Integration](/subsystems/pathfinding)

---

## 🪐 Team Philosophy & Culture

### How does MARSLib support the _FIRST_® Core Values?
...
- **Inclusion**: Our "Zero-Mocking" simulation philosophy ensures that every student can participate in high-level programming, even without access to a physical robot.
...
- **Impact**: We measure our success not just by match wins, but by the technical growth and professional preparation of our students.
