...
- **Below 7**: 📚 Keep learning! Try the [Beginner Learning Path](/learning-paths/beginner).
...
- → Ready for [Intermediate Learning Path](/learning-paths/intermediate)
...
- → Try the [Beginner Learning Path](/learning-paths/beginner)

**If you got below 7**:
- → Start with [Beginner Learning Path](/learning-paths/beginner)
