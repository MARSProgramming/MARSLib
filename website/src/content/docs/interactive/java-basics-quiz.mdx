...
- → Learn about [FRC Programming](/tutorials/frc-programming)
- → Build your first [Robot Command](/tutorials/commands)

**If you got 7-12 correct**:
- → Review [Java Basics](/tutorials/java-basics)
- → Practice more [Examples](/tutorials/examples)
- → Try the [Beginner Learning Path](/learning-paths/beginner)

**If you got below 7**:
- → Start with [Beginner Learning Path](/learning-paths/beginner)
- → Learn [Java from Scratch](/tutorials/java-from-scratch)
