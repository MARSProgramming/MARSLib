...
*Complete the [Beginner Learning Path](/learning-paths/beginner) to level up!*
...
**No milestones yet!** Start your learning journey with the [Beginner Learning Path](/learning-paths/beginner).
...
- [ ] [Beginner Learning Path](/learning-paths/beginner)
...
*Ready to start?* [Beginner Learning Path](/learning-paths/beginner) awaits!