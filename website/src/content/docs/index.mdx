...
template: splash
hero:
  tagline: "A zero-allocation, physics-simulated FRC framework with deterministic AdvantageKit logging, 250Hz odometry, and shot-on-the-move kinematics."
  actions:
    - text: 🎓 TUTORIALS
      link: /tutorials/setup/getting-started/
      variant: primary
...
<div style={{ display: 'flex', justifyContent: 'center', marginTop: '-40px', marginBottom: '40px' }}>
  <Image src={marsLogo} alt="MARSLib Logo" width={300} style={{ filter: 'drop-shadow(0 0 20px rgba(179,36,22,0.15))' }} />
</div>
