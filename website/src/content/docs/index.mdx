...
<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', marginTop: '20px', marginBottom: '40px' }}>
  <img src="/img/mars-logo.png" alt="MARSLib Logo" width="300" style={{ filter: 'brightness(0) invert(1) drop-shadow(0 0 20px rgba(179,36,22,0.3))', marginBottom: '20px', objectFit: 'contain' }} />
  <h1 style={{ fontSize: '3rem', margin: '0 0 10px 0' }}>MARSLib Framework</h1>
