...
description: "complete guide to integrating vision systems with MARSLib. AprilTag detection, MegaTag 2.0 localization, and camera setup for accurate robot positioning."
sidebar:
  order: 3
---
...
- [Field Visualization](/framework-structure/field-visualization) - 3D field reference.
