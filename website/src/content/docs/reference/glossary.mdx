...
**Found a term that's missing?** [Suggest additions](https://github.com/MARSProgramming/MARSLib/issues)

**Found an explanation confusing?** [Request simplification](https://github.com/MARSProgramming/MARSLib/issues)
