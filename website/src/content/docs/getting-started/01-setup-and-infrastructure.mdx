...
Before you can begin programming the robot, you must embark on a path of **Discovery**. Setting up your local development environment is your first opportunity for **Innovation**—mastering the tools that will allow you to build world-class robotic systems. 

Follow these steps meticulously to configure MARSLib's advanced zero-allocation architecture and prepare for a season of technical **Impact**. Note this is still a work in progress.

:::tip
**New!** We now have a dedicated **[MARSLib VS Code Extension](/getting-started/02-first-subsystem/)** to automate your workflow. Section 2 below has been updated with installation details.
:::


## <span class="mars-num">1</span> WPILib Installation

WPILib is the official library for _FIRST_® Robotics. It comes bundled with a custom version of Visual Studio Code, a localized JDK, and the necessary Gradle toolchains to compile FRC robot code.
...
**[Read the full Extension Guide & Download here &rarr;](/getting-started/02-first-subsystem/)**
...
---
  ...
  ## ?? Further Reading & External Resources
    ...
    - [WPILib "Zero to Robot" Guide](https://docs.wpilib.org/en/stable/docs/zero-to-robot/introduction.html) - The official foundational pipeline for **_FIRST_®** control systems.

    - [FRC 0 to Auto Youtube Series](https://www.youtube.com/watch?v=8319J1BEHwM) - Outstanding video tutorials exploring command-based programming for **_FIRST_®** students.
