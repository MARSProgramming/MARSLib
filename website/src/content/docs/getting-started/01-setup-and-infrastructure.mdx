...
Follow these steps meticulously to configure MARSLib's advanced zero-allocation structure and prepare for a season of technical **Impact**. Note this is still a work in progress.
...
---
  ...
  ## ?? Further Reading & External Resources
    ...
    - [WPILib Command-Based Documentation](https://docs.wpilib.org/en/stable/docs/software/commandbased/index.html) - Deep dive into Subsystem and Command scheduling structure.
