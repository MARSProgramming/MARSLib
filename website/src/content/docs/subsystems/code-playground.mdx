...
✅ **DO** use MARSLib's IO abstractions for hardware independence
...
- Check out the [State Machine tutorial](/framework-structure/state-machines) for advanced coordination.
