...
description: "Visual structure diagrams of MARSLib's core systems, data flow, and package structure."
sidebar:
  order: 1
---
...
- [Framework structure](/framework-structure/structure) - Detailed structure discussion.
- [IO Abstraction](/framework-structure/io-layer) - IO layer setup.
