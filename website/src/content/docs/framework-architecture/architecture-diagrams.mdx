...
- [Framework Architecture](/framework-architecture/architecture) - Detailed architecture discussion
- [IO Abstraction](/framework-architecture/io-layer) - IO layer implementation
- [Testing Philosophy](/contributing/testing-guide) - Digital Twin testing approach
- [Performance Analysis](/advanced/performance-analysis) - Performance monitoring tools
