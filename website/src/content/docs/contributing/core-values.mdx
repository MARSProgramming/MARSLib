...
FRC engineering is inherently difficult. We actively encourage students to embrace the friction of learning hard things. Transitioning to zero-allocation loops, advanced odometry, and high-fidelity physics is uncomfortable—but leaning into that discomfort is exactly where genuine growth happens.
