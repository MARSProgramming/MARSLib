...
**Swerve &amp; Mechanisms Template**
    ...
    Our agentic skills dynamically generate the <code>MARS_Standard_Layout.json</code> layout file for the 2614 layout. You can find this inside the root directory under <code>.agents/layouts/</code>.
:::
