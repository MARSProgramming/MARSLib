...
**What is Git?**
    ...
    <a href="https://git-scm.com/" target="_blank">Git</a> is a "Time Machine" for your code. It tracks exactly who changed which lines in a file, allowing multiple robot programmers to safely write code simultaneously without accidentally deleting each other's work.
:::
