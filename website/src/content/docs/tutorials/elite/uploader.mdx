...
The RoboRIO needs permission to upload directly to your team's GitHub organization.
  ...
  <ol >
    <li >Navigate to: *Settings* &rarr; *Developer Settings* &rarr; *[Personal Access Tokens](https://github.com/settings/tokens)*.</li>
    <li >Generate a new token with **Read &amp; Write** access to **Contents**.</li>
    <li >Copy the exact token string (it will start with `github_pat_`).</li>
