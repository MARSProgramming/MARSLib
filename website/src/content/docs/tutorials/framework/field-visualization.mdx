...
```typescript
import { FIELDS, createFieldLayout, spawnGamePieces } from '@components/field/FieldData';
...
### Position Validation
```typescript
import { isInField } from '@components/field/FieldData';
...
- [Vision Systems](/tutorials/framework/vision) - AprilTag detection and localization
- [Autonomous Pathing](/tutorials/framework/pathfinding) - Path planning and execution
- [Simulation Best Practices](/tutorials/advanced/simulation-best-practices) - Physics simulation techniques
