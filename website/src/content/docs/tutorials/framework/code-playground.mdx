...
- Check out the [State Machine tutorial](/tutorials/framework/state-machines) for advanced coordination
- Learn about [Vision Systems](/tutorials/framework/vision) for AprilTag integration
- Study [Swerve Drive](/tutorials/framework/swerve) for autonomous path following
