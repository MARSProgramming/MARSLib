  ...
  <div className="simulator-container">
    <div >
      <div>
        ...
        <p >Visualizing Iterative Convergence & Vector Interception</p>
      </div>
    </div>
    
    <canvas id="sotmCanvas" width="800" height="400" ></canvas>
    
    <div >
      <div >
        <label >Robot Velocity: <span id="velDisplay" >4.0 m/s</span></label>
        <input type="range" id="botVelocity" min="0" max="8" value="4" step="0.1" autocomplete="off"  />
      </div>
      <div >
        <label >Robot Heading: <span id="headDisplay" >0&deg;</span></label>
        <input type="range" id="botHeading" min="-180" max="180" value="0" step="1" autocomplete="off"  />
      </div>
      <div >
        <label >Muzzle Velocity: <span id="shotDisplay" >15.0 m/s</span></label>
        <input type="range" id="shotSpeed" min="5" max="30" value="15" step="0.5" autocomplete="off"  />
      </div>
    </div>
