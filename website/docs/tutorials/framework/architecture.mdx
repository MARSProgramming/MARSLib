...
|---------|-------------|-------------|
| [`com.marslib.swerve`](/MARSLib/javadoc/com/marslib/swerve/package-summary.html) | 250Hz odometry, swerve kinematics, traction control | `SwerveDrive`, `SwerveModule`, `PhoenixOdometryThread` |
| [`com.marslib.vision`](/MARSLib/javadoc/com/marslib/vision/package-summary.html) | AprilTag localization with MegaTag 2.0 fusion | `MARSVision`, `VisionIO` |
| [`com.marslib.mechanisms`](/MARSLib/javadoc/com/marslib/mechanisms/package-summary.html) | Generic IO abstractions | `RotaryMechanismIO`, `LinearMechanismIO` |
| [`com.marslib.faults`](/MARSLib/javadoc/com/marslib/faults/package-summary.html) | Thread-safe fault reporting | `MARSFaultManager`, `Alert` |
| [`com.marslib.simulation`](/MARSLib/javadoc/com/marslib/simulation/package-summary.html) | Dyn4j physics world, game piece spawning | `MARSPhysicsWorld`, `GamePieceBody` |
| [`com.marslib.power`](/MARSLib/javadoc/com/marslib/power/package-summary.html) | Voltage load-shedding and stator monitoring | `MARSPowerManager` |
| [`com.marslib.util`](/MARSLib/javadoc/com/marslib/util/package-summary.html) | State machines, tunable numbers, shot math | `MARSStateMachine`, `EliteShooterMath` |
| [`com.marslib.auto`](/MARSLib/javadoc/com/marslib/auto/package-summary.html) | PathPlanner integration, alignment commands | `MARSAutoBuilder` |
