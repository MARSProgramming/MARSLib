...
<main className="container" >
  ...
  <div className="callout callout-warning">
      ...
      <ul>
          <li><strong>CAN Timeouts</strong>: Detecting disconnected motors or CANivro buses.</li>
      ...
      <p>This layer propagates errors to the human team. Active faults are configured using persistent <code>Alert</code> objects from WPILib web components and broadcast directly to AdvantageScope or the Driver Station.</p>
  </div>
