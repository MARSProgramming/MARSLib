  ...
  <div className="simulator-container" >
    <div >
      <div>
        ...
        <p >Drag the blue robot chassis to collide with the Fuel Balls. Hit them into the glowing goal on the left!</p>
      </div>
      <button id="resetSimBtn" className="btn btn-primary" >RESET WORLD</button>
    </div>
