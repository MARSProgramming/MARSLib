		...
		plugins: [
			{
				...
				transform(code, id) {
					if (id.endsWith('.mdx') && !id.includes('node_modules')) {
						const inject = `import { ArmKgSim, AutoSim, ElevatorPidSim, FaultSim, FlywheelKvSim, PhysicsSim, PowerSheddingSim, SotmSim, StateMachineSim, SwerveSim, SysIdSim, VisionSim, ZeroAllocationSim, CodePlayground, FieldVisualizer, RuleSection, CodeComparison, CodeViolation, CodeStandard, StandardHeader, SplashContainer, HomeHero, HomeSimulatorContainer, HomeCoreValues, HomeHallOfFame, HomeTutorialGrid, SponsorsList, CoreValueCallout } from '/src/components/index.ts';\nimport Mermaid from '/src/components/Mermaid.astro';\n\n`;
